    ...
    <ScrollView style={styles.container}>
      ...
      <View style={{ marginTop: 20 }}>
        <ScrollView horizontal={true}>
          <View style={{ flexDirection: "row", gap: 15 }}>
            {images.map((e, i) => {
              // ini galerinya, yang bisa trigger imageviewnya
              return (
                <TouchableOpacity
                  key={e.id}
                  activeOpacity={0.8}
      ...
      <View style={styles.perContent}>
        ...
        <Text>
          ...
          distinctio esse odio animi! Corrupti, explicabo. Fugit reprehenderit
          reiciendis autem?
        </Text>
      </View>
      ...
      >
        <Button
          ...
          onPress={handleBookScreen}
        >
          Book Now
        </Button>
        <Button mode="contained" theme={{ colors: { primary: "#48034F" } }}>
          Chat
        </Button>
      </View>
